-- M2.4.4 map directory hardening.
-- The public directory list still requests 24 rows per page, while map view may
-- request up to 500 matching campground IDs so all markers in the MVP ceiling
-- can be rendered. RLS and published-only eligibility remain unchanged.
