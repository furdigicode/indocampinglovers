  ...
  return (
    <form action="/camping" method="get" className="mt-6 rounded-3xl border border-black/10 bg-white p-4 shadow-sm md:p-5">
      ...
      <details className="group" open={activeCount > 0 ? true : undefined}>
        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-bold text-forest-900 md:pointer-events-none">
          ...
          <span className="text-xs font-semibold text-forest-700 md:hidden">Buka / tutup</span>
        </summary>
